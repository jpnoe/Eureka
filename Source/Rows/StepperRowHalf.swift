...
open class StepperCellHalf: Cell<Double>, CellType {
...
open class _StepperRowHalf: Row<StepperCellHalf> {
...
public final class StepperRowHalf: _StepperRowHalf, RowType {
    required public init(tag: String?) {
        super.init(tag: tag)
    }
}
